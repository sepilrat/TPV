...
def inicializar_db():
    ...
    migraciones = [
        ...
        # La ventana de editar producto ya pedía estos dos campos y los
        # mandaba a guardar, pero la columna nunca se había creado acá
        # — por eso el botón "Guardar" tiraba un error silencioso.
        ...
        # Mismo caso que en productos: la ventana de Categorías ya
